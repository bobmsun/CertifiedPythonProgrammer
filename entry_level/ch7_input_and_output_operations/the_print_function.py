...
# Above we take some use input
# Then we want to present it back
print(name)
print("is " + str(age) + " years old")       # 这里不把 age 转化成 str 会报错，TypeError: can only concatenate str (not "int") to str
...
# Main takeaway
# The print() function can take as many argument as you want, before you start specifying the things the customerize how print works

...
else:   # the else block will get executed if we are able to make it all the through the try block without an error
...
try: 
    ...
    # Remember when we ask a class if it is a type of instance, 如果我们ask if it is a type of parent class, it's going to say yes.
